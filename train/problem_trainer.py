...
class ProblemTrainer(object):
    def __init__(self,
        ...
        if self.mode == "mobilenetv2" and self.input_shape[0] == 224:
            self.model_path = os.path.join(DATA_DIR, 'models', 'rotnet_v3_mobilenetv2_base224_20201205_3.1.h5')
        elif self.mode == "mobilenetv2" and self.input_shape[0] == 448:
            self.model_path = os.path.join(DATA_DIR, 'models', 'rotnet_v3_mobilenetv2_base448_20201205_2.2.h5')
        elif self.mode == "resnet50":
            self.model_path = os.path.join(DATA_DIR, 'models', 'rotnet_v3_resnet50_base224_20201205.3.h5')
